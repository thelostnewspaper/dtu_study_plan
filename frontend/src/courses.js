...
export const COURSE_CATALOG = {
  "12100": { name: "Quantitative Methods to Assess Sustainability", ects: 5, sem: ["Spring"], cat: "mandatory", specs: [], slot: 'F1A', desc: "Life-cycle assessment, environmental impact quantification." },
  "12101": { name: "Quantitative Methods to Assess Sustainability", ects: 5, sem: ["Spring"], cat: "mandatory", specs: [], slot: 'F1B', desc: "Life-cycle assessment, environmental impact quantification." },
  "12105": { name: "Quantitative Methods to Assess Sustainability", ects: 5, sem: ["Autumn"], cat: "mandatory", specs: [], slot: 'E1A', desc: "Life-cycle assessment, environmental impact quantification (Evening slot)." },
  "12106": { name: "Quantitative Methods to Assess Sustainability", ects: 5, sem: ["Autumn"], cat: "mandatory", specs: [], slot: 'E1B', desc: "Life-cycle assessment, environmental impact quantification." },
  "42500": { name: "Innovation in Engineering", ects: 5, sem: ["January"], cat: "mandatory", specs: [], slot: 'Jan', desc: "Entrepreneurship, design thinking, innovation processes." },
  "42501": { name: "Innovation in Engineering", ects: 5, sem: ["June"], cat: "mandatory", specs: [], slot: 'Jun', desc: "Entrepreneurship, design thinking, innovation processes." },
  "42504": { name: "Innovation in Engineering", ects: 5, sem: ["August"], cat: "mandatory", specs: [], slot: 'Aug', desc: "Entrepreneurship, design thinking, innovation processes." },
  "42502": { name: "Facilitating Innovation in Multidisciplinary Teams", ects: 5, sem: ["January"], cat: "mandatory", specs: [], slot: 'Jan', desc: "Team dynamics, innovation design, creative facilitation." },
  "42503": { name: "Facilitating Innovation in Multidisciplinary Teams", ects: 5, sem: ["June"], cat: "mandatory", specs: [], slot: 'Jun', desc: "Team dynamics, innovation design, creative facilitation." },
  "42505": { name: "Facilitating Innovation in Multidisciplinary Teams", ects: 5, sem: ["August"], cat: "mandatory", specs: [], slot: 'Aug', desc: "Team dynamics, innovation design, creative facilitation." },
  ...
  "38102": { name: "Technology Entrepreneurship", ects: 5, sem: ["Autumn"], cat: "innov2", specs: [], slot: 'E2A', desc: "Business modeling, startup creation, commercialization strategies." },
  "38103": { name: "X-Tech Entrepreneurship", ects: 10, sem: ["Autumn", "Spring"], cat: "innov2", specs: [], slot: 'E3B', desc: "Project incubator connecting researchers and students to build startups." },
  "38106": { name: "Developing an Entrepreneurial Mindset", ects: 5, sem: ["Spring", "Autumn"], cat: "innov2", specs: [], slot: 'E3B', desc: "Creativity, mindset building, startup exploration." },
  ...
  "02225": { name: "Distributed Real-Time Systems", ects: 5, sem: ["Spring"], cat: "core", specs: ["digital", "embedded"], slot: 'F4A', desc: "Real-time scheduling, fault tolerance, distributed protocols." },
  ...
  "02282": { name: "Algorithms for Massive Data Sets", ects: 7.5, sem: ["Spring"], cat: "prog", specs: ["ai"], slot: 'F2B', desc: "Streaming algorithms, hashing, handling giant data collections." },
  ...
  "02289": { name: "Algorithmic Techniques for Modern Data Models", ects: 5, sem: ["Autumn"], cat: "prog", specs: ["ai"], slot: 'E1B', desc: "Advanced graph algorithms, data structures, metric spaces." },
  "02291": { name: "System Integration", ects: 5, sem: ["Spring"], cat: "core", specs: ["ai", "cyber", "digital", "embedded", "safe", "software"], slot: 'F3A', desc: "Heterogeneous systems, APIs, middleware, SOA." },
  "02417": { name: "Time Series Analysis", ects: 5, sem: ["Spring"], cat: "elective", specs: [], slot: 'F4A', desc: "Statistical modeling of sequential data, forecasting, ARIMA, state-space models." },
  "02452": { name: "Machine Learning", ects: 5, sem: ["Autumn"], cat: "elective", specs: ["ai"], slot: 'E2A', desc: "Supervised/unsupervised learning, neural networks, model selection, evaluation." },
  "02456": { name: "Deep Learning", ects: 5, sem: ["Autumn"], cat: "elective", specs: ["ai"], slot: 'E2B', desc: "CNNs, RNNs, transformers, generative models, practical deep learning." },
  "02471": { name: "Machine Learning for Signal Processing", ects: 5, sem: ["Autumn"], cat: "prog", specs: ["ai"], slot: 'E3A', desc: "Advanced understanding of machine learning techniques applied to signal processing." },
  "02476": { name: "MLOps", ects: 5, sem: ["January"], cat: "elective", specs: ["ai"], slot: 'Jan', desc: "ML deployment pipelines, monitoring, CI/CD for ML, containerization." },
  "02517": { name: "Responsible AI", ects: 5, sem: ["Autumn"], cat: "elective", specs: ["ai"], slot: 'E4A', desc: "Fairness, accountability, transparency, ethics in AI systems." },
  "02807": { name: "Computational Tools for Data Science", ects: 5, sem: ["Autumn"], cat: "elective", specs: ["ai"], slot: 'E4B', desc: "Python data stack, visualization, big-data tools, reproducible workflows." }
};
